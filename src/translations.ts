export const translations = {
  es: {
    ...
    termsPrivacyContent: 'Las imágenes que subes son procesadas para realizar predicciones y no se almacenan permanentemente en nuestros servidores después del análisis. No recopilamos información personal identificable. Tu ubicación se utiliza únicamente para mostrarte puntos de reciclaje cercanos y no se almacena ni comparte con terceros.',
  ...
  en: {
    ...
    termsPrivacyContent: 'Images you upload are processed for predictions and are not permanently stored on our servers after analysis. We do not collect personally identifiable information. Your location is used only to show you nearby recycling points and is not stored or shared with third parties.',
