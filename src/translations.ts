export const translations = {
  es: {
    ...
    termsLastUpdated: 'Última actualización: 1 de febrero de 2026',
    ...
    termsServiceContent: 'TrashIA es una aplicación de clasificación de residuos que utiliza inteligencia artificial para identificar materiales y proporcionar información sobre reciclaje. El servicio incluye clasificación de imágenes, un mapa de puntos de reciclaje, escaneo de códigos de barras, un asistente virtual de reciclaje, registro de usuarios con perfiles personalizados y estadísticas de impacto ambiental.',
    termsUsageTitle: 'Uso Aceptable',
    termsUsageContent: 'Te comprometes a utilizar TrashIA únicamente para fines legítimos relacionados con el reciclaje y la clasificación de residuos. No está permitido el uso de la aplicación para propósitos ilegales, ofensivos o que puedan dañar el servicio o a otros usuarios. Al crear una cuenta, aceptas proporcionar información veraz y mantener la confidencialidad de tus credenciales.',
    ...
    termsPrivacyContent: 'Las imágenes que subes son procesadas para realizar predicciones y no se almacenan permanentemente en nuestros servidores después del análisis. Si creas una cuenta, almacenamos tu información de perfil (nombre, apellido, email, teléfono y foto de perfil) en Supabase, un servicio seguro de base de datos. Tu ubicación es enviada a OpenStreetMap (Overpass API) para encontrar puntos de reciclaje cercanos, los códigos de barras escaneados se consultan en Open Food Facts y UPCitemdb, y tus mensajes de chat se procesan mediante Groq. Las estadísticas de clasificación se almacenan localmente en tu dispositivo.',
    termsThirdPartyTitle: 'Servicios de Terceros',
    termsThirdPartyContent: 'TrashIA utiliza servicios externos como Groq para el asistente de chat, OpenStreetMap para mapas de ubicación, Open Food Facts junto con UPCitemdb para información de productos escaneados, y Supabase para autenticación y almacenamiento de perfiles de usuario. El análisis de imágenes se realiza con nuestro propio modelo de inteligencia artificial TrashIAv2. El uso de servicios externos está sujeto a sus respectivos términos y políticas de privacidad.',
    ...
    authWelcomeBack: 'Bienvenido de vuelta a TrashIA',
    authJoinCommunity: 'Únete a la comunidad TrashIA',
    authLoggingIn: 'Iniciando sesión...',
    authRegistering: 'Creando cuenta...',
    authPasswordMismatch: 'Las contraseñas no coinciden',
    authEmailVerified: '¡Email verificado correctamente!',
    authVerificationSent: 'Te hemos enviado un correo de verificación.',
  ...
  en: {
    ...
    termsServiceContent: 'TrashIA is a waste classification application that uses artificial intelligence to identify materials and provide recycling information. The service includes image classification, a recycling points map, barcode scanning, a virtual recycling assistant, user registration with personalized profiles, and environmental impact statistics.',
    termsUsageTitle: 'Acceptable Use',
    termsUsageContent: 'You agree to use TrashIA only for legitimate purposes related to recycling and waste classification. The use of the application for illegal, offensive purposes or those that may harm the service or other users is not permitted. By creating an account, you agree to provide accurate information and maintain the confidentiality of your credentials.',
    ...
    termsPrivacyContent: 'Images you upload are processed for predictions and are not permanently stored on our servers after analysis. If you create an account, we store your profile information (name, last name, email, phone, and profile picture) in Supabase, a secure database service. Your location is sent to OpenStreetMap (Overpass API) to find nearby recycling points, scanned barcodes are queried against Open Food Facts and UPCitemdb, and your chat messages are processed through Groq. Classification statistics are stored locally on your device.',
    termsThirdPartyTitle: 'Third-Party Services',
    termsThirdPartyContent: 'TrashIA uses external services such as Groq for the chat assistant, OpenStreetMap for location maps, Open Food Facts along with UPCitemdb for scanned product information, and Supabase for authentication and user profile storage. Image analysis is performed with our own TrashIAv2 artificial intelligence model. The use of external services is subject to their respective terms and privacy policies.',
    ...
    authWelcomeBack: 'Welcome back to TrashIA',
    authJoinCommunity: 'Join the TrashIA community',
    authLoggingIn: 'Signing in...',
    authRegistering: 'Creating account...',
    authPasswordMismatch: 'Passwords do not match',
    authEmailVerified: 'Email verified successfully!',
    authVerificationSent: 'We sent you a verification email.',
